<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
    <input class="mdl-textfield__input {{$errors->has('name') ? 'is-invalid' : '' }}" type="text" name="name" pattern="-?[A-Za-záéíóúÁÉÍÓÚ ]*(\.[0-9]+)?" id="name" value="{{ old('name', $client->name)}}">
...
<div class="mdl-textfield mdl-js-textfield mdl-textf    ield--floating-label">
    <input class="mdl-textfield__input {{$errors->has('last_name') ? 'is-invalid' : '' }}" type="text" name="last_name" pattern="-?[A-Za-záéíóúÁÉÍÓÚ ]*(\.[0-9]+)?" id="last_name" value="{{ old('last_name', $client->last_name)}}" >
...
<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">-
    <select class="mdl-textfield__input" name="id_type" id="id_type" value="{{ old('id_type', $client->id_type)}}">
...
<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
    <input class="mdl-textfield__input {{$errors->has('identification') ? 'is-invalid' : ''}}" type="text" name="identification" pattern="-?[0-9]*(\.[0-9]+)?" id="identification" value="{{ old('identification', $client->identification)}}" >
...
<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
    <input class="mdl-textfield__input {{$errors->has('phone') ? 'is-invalid' : ''}}" type="number" name="phone" pattern="-?[0-9+()- ]*(\.[0-9]+)?" id="phone" value="{{ old('phone', $client->phone)}}">
...
<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
    <input class="mdl-textfield__input {{$errors->has('email') ? "is-invalid" : ''}}" name="email" type="email" id="email" value="{{ old('email', $client->email)}}">
...
<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
    <input class="mdl-textfield__input {{$errors->has('address') ? 'is-invalid' : ''}}" name="address" type="text" id="address" value="{{ old('address', $client->address)}}">
