...
<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
    <input class="mdl-textfield__input {{$errors->has('identification') ? 'is-invalid' : ''}}" type="text" name="identification" pattern="-?[0-9]*(\.[0-9]+)?" id="identification">
...
<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
    <input class="mdl-textfield__input {{$errors->has('phone') ? 'is-invalid' : ''}}" type="number" name="phone" pattern="-?[0-9+()- ]*(\.[0-9]+)?" id="phone">
...
<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
    <input class="mdl-textfield__input {{$errors->has('email') ? "is-invalid" : ''}}" name="email" type="email" id="email">
...
<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
    <input class="mdl-textfield__input {{$errors->has('address') ? 'is-invalid' : ''}}" name="address" type="text" id="address">
