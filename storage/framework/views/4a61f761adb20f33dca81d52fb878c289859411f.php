                ...
                <div id="myTabContent" class="tab-content">
                    ...
                    <div role="tabpanel" class="tab-pane fade active in" id="home" aria-labelledby="home-tab">
                        <div class="agile_ecommerce_tabs">
                            <div class="col-md-4 agile_ecommerce_tab_left">
                                <div class="">
                                    <img src="<?php echo e(asset('store/images/3.jpg')); ?>" alt=" " class="img-responsive" />
                                </div>
                            ...
                            <div class="col-md-4 agile_ecommerce_tab_left">
                                <div class="">
                                    <img src="<?php echo e(asset('store/images/4.jpg')); ?>" alt=" " class="img-responsive" />
                                </div>
                    ...
                    <div role="tabpanel" class="tab-pane fade" id="audio" aria-labelledby="audio-tab">
                        <div class="agile_ecommerce_tabs">
                            <div class="col-md-4 agile_ecommerce_tab_left">
                                <div class="">
                                    <img src="<?php echo e(asset('store/images/8.jpg')); ?>" alt=" " class="img-responsive" />
                                </div>
                            ...
                            <div class="col-md-4 agile_ecommerce_tab_left">
                                <div class="">
                                    <img src="<?php echo e(asset('store/images/9.jpg')); ?>" alt=" " class="img-responsive" />
                                </div>
                            ...
                            <div class="col-md-4 agile_ecommerce_tab_left">
                                <div class="">
                                    <img src="<?php echo e(asset('store/images/10.jpg')); ?>" alt=" " class="img-responsive" />
                                </div>
                    ...
                    <div role="tabpanel" class="tab-pane fade" id="video" aria-labelledby="video-tab">
                        <div class="agile_ecommerce_tabs">
                            <div class="col-md-4 agile_ecommerce_tab_left">
                                <div class="">
                                    <img src="<?php echo e(asset('store/images/11.jpg')); ?>" alt=" " class="img-responsive" />
                                </div>
                            ...
                            <div class="col-md-4 agile_ecommerce_tab_left">
                                <div class="">
                                    <img src="<?php echo e(asset('store/images/12.jpg')); ?>" alt=" " class="img-responsive" /
                                </div>
        ...
        <div class="w3agile_special_deals_grids">
            <div class="col-md-7 w3agile_special_deals_grid_left">
                <div class="w3agile_special_deals_grid_left_grid">
                    <img src="<?php echo e(asset('store/images/21.jpg')); ?>" alt=" " class="img-responsive" />
                ...
                <script src="<?php echo e(mix('js/store/all.js')); ?>" ></script>
            </div>
            <div class="col-md-5 w3agile_special_deals_grid_right">
                <img src="<?php echo e(asset('store/images/20.jpg')); ?>" alt=" " class="img-responsive" />
        ...
        <div class="agileinfo_new_products_grids">
            <div class="col-md-3 agileinfo_new_products_grid">
                <div class="agile_ecommerce_tab_left agileinfo_new_products_grid1">
                    <div class="">
                        <img src="<?php echo e(asset('store/images/25.jpg')); ?>" alt=" " class="img-responsive" />
                    </div>
            ...
            <div class="col-md-3 agileinfo_new_products_grid">
                <div class="agile_ecommerce_tab_left agileinfo_new_products_grid1">
                    <div class="">
                        <img src="<?php echo e(asset('store/images/27.jpg')); ?>" alt=" " class="img-responsive" />
                    </div>
            ...
            <div class="col-md-3 agileinfo_new_products_grid">
                <div class="agile_ecommerce_tab_left agileinfo_new_products_grid1">
                    <div class="">
                        <img src="<?php echo e(asset('store/images/34.jpg')); ?>" alt=" " class="img-responsive" />
                    </div>
            ...
            <div class="col-md-3 agileinfo_new_products_grid">
                <div class="agile_ecommerce_tab_left agileinfo_new_products_grid1">
                    <div class="">
                        <img src="<?php echo e(asset('store/images/37.jpg')); ?>" alt=" " class="img-responsive" />
                    </div>
...
<div class="top-brands">
    <div class="container">
        ...
        <div class="sliderfig">
            <ul id="flexiselDemo1">
                <li>
                    <img src="<?php echo e(asset('store/images/tb1.jpg')); ?>" alt=" " class="img-responsive" />
                </li>
                <li>
                    <img src="<?php echo e(asset('store/images/tb2.jpg')); ?>" alt=" " class="img-responsive" />
                </li>
                <li>
                    <img src="<?php echo e(asset('store/images/tb3.jpg')); ?>" alt=" " class="img-responsive" />
                </li>
                <li>
                    <img src="<?php echo e(asset('store/images/tb4.jpg')); ?>" alt=" " class="img-responsive" />
                </li>
                <li>
                    <img src="<?php echo e(asset('store/images/tb5.jpg')); ?>" alt=" " class="img-responsive" />
                </li>
            </ul>
        </div>
        ...
        <script type="text/javascript" src="<?php echo e(mix('js/store/all.js')); ?>"></script>
    </div>
</div>
<!-- //top-brands -->
...
<?php echo $__env->make('store.layout.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\SEBASTIAN\laragon\www\Reto\resources\views/store/home.blade.php ENDPATH**/ ?>